...
unlocked to sign the Kreds-Qt.app bundle.
...
allowing somebody to distribute a Kreds-Qt.app or kreds-qt-setup.exe with a valid
...
that the kreds-qt.exe file inside the installer had not been tampered with.

...
WORKINGDIR="/tmp/kreds"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/kreds/Kreds/kreds-0.9.0rc1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/kreds/Kreds/"
VERSIONPREFIX="kreds-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[kreds-]<version>-[rc[0-9]] (example: kreds-0.7.1-rc1)"
   echo "wget output:"

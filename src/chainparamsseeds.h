#ifndef KREDS_CHAINPARAMSSEEDS_H
#define KREDS_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the kreds network
 ...
 */
 ...
 /**TODO-- set seeds from generate-seeds.py*/
...
#endif // KREDS_CHAINPARAMSSEEDS_H

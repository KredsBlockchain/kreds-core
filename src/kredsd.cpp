 ...
 *
 * This is the developer documentation of the reference client for an experimental new digital currency called kreds (https://www.kreds.org/),
 * which enables instant payments to anyone, anywhere in the world. kreds uses peer-to-peer technology to operate
...
bool AppInit(int argc, char* argv[])
{
    ...
    // Parameters
    //
    // If Qt is used, parameters/kreds.conf are parsed in qt/kreds.cpp's main()
    ...
    if (IsArgSet("-?") || IsArgSet("-h") ||  IsArgSet("-help") || IsArgSet("-version"))
    {
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  kredsd [options]                     " + strprintf(_("Start %s Daemon"), _(PACKAGE_NAME)) + "\n";

            strUsage += "\n" + HelpMessage(HMM_KREDSD);
        }
...
int main(int argc, char* argv[])
{
    ...
    // Connect kredsd signal handlers
    noui_connect();

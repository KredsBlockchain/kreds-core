/* src/config/kreds-config.h.  Generated from kreds-config.h.in by configure.  */
/* src/config/kreds-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef KREDS_CONFIG_H

#define KREDS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Kreds developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Kreds"
...
#define PACKAGE_BUGREPORT "https://github.com/kreds/kreds/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Kreds"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Kreds 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kreds"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://kredsblockchain.com/"

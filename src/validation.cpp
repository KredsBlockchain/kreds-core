...
CAmount GetBlockSubsidy(int nBits, int nHeight, const Consensus::Params& consensusParams)
{
    ...
    if (nHeight > 2)
        nSubsidy = 225 * COIN;
    if (nHeight > 131400)
        nSubsidy = 221.625 * COIN;
    if (nHeight > 262800)
        nSubsidy = 218.300625 * COIN;
    if (nHeight > 394200)
        nSubsidy = 215.026115 * COIN;
    if (nHeight > 525600)
        nSubsidy = 211.800730 * COIN;
    if (nHeight > 657000)
        nSubsidy = 208.623720 * COIN;
    if (nHeight > 788400)
        nSubsidy = 205.4944 * COIN;
    if (nHeight > 919800)
        nSubsidy = 202.4119 * COIN;
    if (nHeight > 1051200)
        nSubsidy = 199.3758 * COIN;
    if (nHeight > 1182600)
        nSubsidy = 196.3851 * COIN;
    if (nHeight > 1314000)
        nSubsidy = 193.4393 * COIN;
    if (nHeight > 1445400)
        nSubsidy = 190.5377 * COIN;
    if (nHeight > 1576800)
        nSubsidy = 187.6796345 * COIN;
    if (nHeight > 1708200)
        nSubsidy = 184.8644 * COIN;
    if (nHeight > 1839600)
        nSubsidy = 182.0915 * COIN;
    if (nHeight > 1971000)
        nSubsidy = 179.3601 * COIN;
    if (nHeight > 2102400)
        nSubsidy = 176.6697 * COIN;
    if (nHeight > 2233800)
        nSubsidy = 174.0197 * COIN;
    if (nHeight > 2365200)
        nSubsidy = 171.4094 * COIN;
    if (nHeight > 2496600)
        nSubsidy = 168.838259 * COIN;
    if (nHeight > 2628000)
        nSubsidy = 166.305686 * COIN;

...
#define BOOST_TEST_MODULE Kreds Test Suite

#include "test_kreds.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_kreds_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));

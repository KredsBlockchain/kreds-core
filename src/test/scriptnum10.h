...
#ifndef KREDS_TEST_SCRIPTNUM10_H
#define KREDS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kreds 0.10.0, for cross-comparison.
 */
public:

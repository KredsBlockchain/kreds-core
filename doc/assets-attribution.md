The following is a list of assets used in the kreds source and their proper attribution.
...
### Info
* Designer: Jonas Schnelli (based on the original kreds logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/kreds.icns, src/qt/res/src/kreds.svg,
	src/qt/res/src/kreds.ico, src/qt/res/src/kreds.png,
	src/qt/res/src/kreds_testnet.png, docs/kreds_logo_doxygen.png,

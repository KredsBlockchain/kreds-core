...
class RawTransactionsTest(KredsTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kreds address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kreds address" in e.error['message'])

...
pkgdatadir = $(datadir)/kreds
pkgincludedir = $(includedir)/kreds
pkglibdir = $(libdir)/kreds
pkglibexecdir = $(libexecdir)/kreds
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/bitsend_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/bitsend_qt.m4 \
	$(top_srcdir)/build-aux/m4/bitsend_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/kreds-config.h
CONFIG_CLEAN_FILES = libkredsconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libkredsconsensus.pc.in \
	...
	$(top_srcdir)/src/config/kreds-config.h.in \
...
ACLOCAL = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
...
COPYRIGHT_HOLDERS_FINAL = The Kreds developers
COPYRIGHT_HOLDERS_SUBSTITUTION = Kreds
COPYRIGHT_YEAR = 2018
CPP = gcc -E
...
KREDS_CLI_NAME = kreds-cli
KREDS_DAEMON_NAME = kredsd
KREDS_GUI_NAME = kreds-qt
KREDS_TX_NAME = kreds-tx
LCOV = 
...
MAINT = 
MAKEINFO = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = kreds
PACKAGE_BUGREPORT = https://github.com/kreds/kreds/issues
PACKAGE_NAME = Kreds
PACKAGE_STRING = Kreds 1.0.0
PACKAGE_TARNAME = kreds
PACKAGE_URL = https://kredsblockchain.com/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/mast3rmind/Coin_Creation/kreds-core
abs_srcdir = /home/mast3rmind/Coin_Creation/kreds-core
abs_top_builddir = /home/mast3rmind/Coin_Creation/kreds-core
abs_top_srcdir = /home/mast3rmind/Coin_Creation/kreds-core
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mast3rmind/Coin_Creation/kreds-core/build-aux/install-sh
...
pkgconfig_DATA = libkredsconsensus.pc
KREDSD_BIN = $(top_builddir)/src/$(KREDS_DAEMON_NAME)$(EXEEXT)
KREDS_QT_BIN = $(top_builddir)/src/qt/$(KREDS_GUI_NAME)$(EXEEXT)
KREDS_CLI_BIN = $(top_builddir)/src/$(KREDS_CLI_NAME)$(EXEEXT)
KREDS_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = kreds-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/kreds.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/kreds-cli.bash-completion \
	       $(top_srcdir)/contrib/kreds-tx.bash-completion \
	       $(top_srcdir)/contrib/kredsd.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/kreds.ico \
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info \
  leveldb_baseline.info test_kreds_filtered.info total_coverage.info \
  baseline_filtered.info rpc_test.info rpc_test_filtered.info \
  leveldb_baseline_filtered.info test_kreds_coverage.info test_kreds.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/kreds.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Kreds-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
CLEANFILES = $(OSX_DMG) $(KREDS_WIN_INSTALLER)
...
src/config/kreds-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/kreds-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/kreds-config.h
$(top_srcdir)/src/config/kreds-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/kreds-config.h src/config/stamp-h1
libkredsconsensus.pc: $(top_builddir)/config.status $(srcdir)/libkredsconsensus.pc.in
...
$(KREDS_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(KREDSD_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(KREDS_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(KREDS_CLI_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/kreds.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/Kreds-Qt: $(KREDS_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kreds-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Kreds-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_kreds.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_kreds -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_kreds_filtered.info: test_kreds.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#rpc_test.info: test_kreds_filtered.info
...
#test_kreds_coverage.info: baseline_filtered_combined.info test_kreds_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kreds_filtered.info -o $@

#total_coverage.info: baseline_filtered_combined.info test_kreds_filtered.info rpc_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_kreds_filtered.info -a rpc_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_kreds.coverage/.dirstamp:  test_kreds_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_kreds.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf coverage_percent.txt test_kreds.coverage/ total.coverage/ qa/tmp/ cache/ $(OSX_APP)
